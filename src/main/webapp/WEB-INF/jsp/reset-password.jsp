...
<head>
    ...
    <style>
        ...
        .form-control { background: white; border: none; border-radius: 8px 0 0 8px; padding: 12px; color: #333; }
        .form-control:focus { background: white; color: #333; box-shadow: none; }
        .input-group-text { background: white; border: none; border-radius: 0 8px 8px 0; color: #666; cursor: pointer; }
...
<body>
    ...
    <div class="card login-card shadow-lg">
        ...
        <c:if test="${not empty message}">
            <div class="alert alert-success text-center mb-3" style="border-radius: 8px;">
                ${message}
            </div>
        </c:if>
        ...
        <div id="jsError" class="alert alert-danger text-center mb-3 d-none" style="border-radius: 8px;"></div>
        ...
        <c:choose>
            ...
            <c:when test="${codeVerified == true}">
                ...
                <form action="${pageContext.request.contextPath}/reset-password" method="POST" onsubmit="return validatePasswords()">
                    <input type="hidden" name="email" value="${email}">
                    <input type="hidden" name="code" value="${code}">
                    
                    <%-- New Password Input Field --%>
                    <div class="mb-3">
                        <label for="newPassword" class="form-label">Type New Password</label>
                        <div class="input-group">
                            <input type="password" class="form-control" id="newPassword" name="newPassword" placeholder="Enter new password" required>
                            <span class="input-group-text" onclick="togglePasswordVisibility('newPassword', 'eyeIcon1')">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-text" onclick="togglePasswordVisibility('confirmPassword', 'eyeIcon2')">
                                <i class="fa-solid fa-eye-slash" id="eyeIcon2"></i>
                            </span>
                        </div>
                    </div>
                    
                    <button type="submit" class="btn btn-action mb-3 mt-2">Save Password</button>
                </form>
            </c:when>
            ...
            <c:otherwise>
                ...
                <form action="${pageContext.request.contextPath}/verify-code" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="code" name="code" placeholder="Enter code from email" style="border-radius: 8px;" required autocomplete="off">
                    </div>
                    
                    <button type="submit" class="btn btn-action mb-3 mt-2">Verify Code</button>

                    <div class="text-center small">
                        Didn't receive the code? <a href="${pageContext.request.contextPath}/forgot-password" class="text-white fw-bold text-decoration-none">Resend Code</a>
                    </div>
                </form>
            </c:otherwise>
        </c:choose>
